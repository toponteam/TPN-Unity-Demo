...
public class BannerHelper {
                            ...
                            if (jsonObject.has("banner_ad_size")) {
                                ...
                                if (mBannerView != null && !TextUtils.isEmpty(banner_ad_size)) {
                                    ...
                                    try {
                                        ...
                                        //非px,需要转换成px
                                        if (!usePixel) {
                                            width = CommonUtil.dip2px(mBannerView.getContext(), width);
                                            height = CommonUtil.dip2px(mBannerView.getContext(), height);
                                        }
    ...
    public void showBannerAd(final int x, final int y, final int width, final int height, final String jsonMap) {
        showBannerAd(x, y, width, height, jsonMap, true);
    }
            ...
            public void run() {
                if (mBannerView != null) {
                    ...
                    if (usePixel) {
                        ...
                        layoutParams = new FrameLayout.LayoutParams(CommonUtil.dip2px(mActivity, width), CommonUtil.dip2px(mActivity, height));
                        layoutParams.leftMargin = CommonUtil.dip2px(mActivity, x);
                        layoutParams.topMargin = CommonUtil.dip2px(mActivity, y);
                    }
